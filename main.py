...
def processImage():
    # TODO: Google Vision API Command/ Script/ Method should be called here...
    recognizedLabel = recognition.getRecognition()

    print(f"[$] Recognized Label: {recognizedLabel}", end="")

    # TODO: After getting recognition, send packet to Java server containing recognized value
    client.connectClient(f"void.send:{recognizedLabel}\n".encode("utf-8"))

    # TODO: Stop Java server after sending recognized value
    client.connectClient(f"stop:0\n".encode("utf-8"))

    # TODO: Then raise KeuboardInterrupt to stop the python server
